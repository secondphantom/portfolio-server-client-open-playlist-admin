...
export async function GET(request: Request, context: { params: any }) {
  try {
    ...
    const result = await router.databaseBackupController.getScheduleById({
...
export async function PATCH(request: Request, context: { params: any }) {
  try {
    ...
    const result = await router.databaseBackupController.updateScheduleById({
      ...body,
      id: params.id,
    });
    return RouterIndex.createJsonResponse(result);
...
export async function DELETE(request: Request, context: { params: any }) {
  try {
    ...
    const result = await router.databaseBackupController.deleteScheduleById({
      id: context?.params?.id,
    });
    return RouterIndex.createJsonResponse(result);
  } catch (error) {
