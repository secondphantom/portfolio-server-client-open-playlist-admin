...
const UserTable = ({
  ...
  userListData: ResponseUserGetListByQuery;
  searchParams: any;
}) => {
  return (
    <Card>
      ...
      <CardFooter>
        <div className="flex flex-col mx-auto space-y-2">
          <div className="text-xs text-muted-foreground mx-auto">
            Showing <strong>{userListData.users.length}</strong> of healths
          </div>
          <ListPagination
            ...
            routePath="/users"
            renderNextPage={
              userListData.users.length === userListData.pagination.pageSize
            }
          />
        </div>
      </CardFooter>
