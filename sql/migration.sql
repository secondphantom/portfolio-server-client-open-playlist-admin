...
CREATE TABLE "DatabaseBackupSchedules" (
    ...
    CONSTRAINT "DatabaseBackupSchedules_pkey" PRIMARY KEY ("id")
);

-- CreateIndex
CREATE INDEX "DatabaseBackupSchedules_is_active_idx" ON "DatabaseBackupSchedules"("is_active");

-- CreateIndex
CREATE INDEX "DatabaseBackupSchedules_is_locked_idx" ON "DatabaseBackupSchedules"("is_locked");

-- CreateIndex
CREATE INDEX "DatabaseBackupSchedules_created_at_idx" ON "DatabaseBackupSchedules"("created_at" DESC);

-- SetTrigger
CREATE TRIGGER table_update
BEFORE UPDATE ON "DatabaseBackupSchedules"
FOR EACH ROW EXECUTE PROCEDURE set_updated_at();


-- CreateTable
CREATE TABLE "DatabaseBackupJobs" (
    "id" BIGSERIAL NOT NULL,
		"uuid" VARCHAR(50) NOT NULL,
		"title" VARCHAR(100) NOT NULL,
    ...
    CONSTRAINT "DatabaseBackupJobs_pkey" PRIMARY KEY ("id")
);

-- CreateIndex
CREATE UNIQUE INDEX "DatabaseBackupJobs_uuid_key" ON "DatabaseBackupJobs"("uuid");

-- CreateIndex
CREATE INDEX "DatabaseBackupJobs_status_idx" ON "DatabaseBackupJobs"("status");

-- CreateIndex
CREATE INDEX "DatabaseBackupJobs_created_at_idx" ON "DatabaseBackupJobs"("created_at" DESC);

-- SetTrigger
CREATE TRIGGER table_update
BEFORE UPDATE ON "DatabaseBackupJobs"
FOR EACH ROW EXECUTE PROCEDURE set_updated_at();